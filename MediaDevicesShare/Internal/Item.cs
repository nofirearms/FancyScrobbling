...
namespace MediaDevices.Internal
{
    ...
    public class Item
    {
        ...
        static Item()
        {
            ...
            keyCollection.Add(ref WPD.MEDIA_USE_COUNT);
            keyCollection.Add(ref WPD.MUSIC_ALBUM);
            keyCollection.Add(ref WPD.MEDIA_ARTIST);
            keyCollection.Add(ref WPD.MEDIA_DURATION);
            keyCollection.Add(ref WPD.MUSIC_TRACK);
            keyCollection.Add(ref WPD.MEDIA_SUB_TITLE);
        ...
        private void GetProperties()
        {
            ...
            for (uint i = 0; i < num; i++)
            {
                ...
                using (PropVariantFacade val = new PropVariantFacade())
                {
                    ...
                    else if(key.fmtid == WPD.MEDIA_PROPERTIES_V1)
                    {
                        switch ((MediaProperties)key.pid)
                        {
                            case MediaProperties.UseCount:
                                this.UseCount = val;
                                break;
                            case MediaProperties.Artist:
                                this.Artist = val;
                                break;
                            case MediaProperties.Duration:
                                this.Duration = val;
                                break;
                            case MediaProperties.Subtitle:
                                this.Subtitle = val;
                                break;
                        }
                    }
                    else if(key.fmtid == WPD.MUSIC_OBJECT_PROPERTIES_V1)
                    {
                        switch ((MusicProperties)key.pid)
                        {
                            case MusicProperties.Album:
                                this.Album = val;
                                break;
                            case MusicProperties.Track:
                                this.Track = val;
                                break;
                        }
                    }
        ...
        internal void SetUseCount(int value)
        {
            ...
            using (PropVariantFacade val = PropVariantFacade.IntToPropVariant(value))
            {
                portableDeviceValues.SetValue(ref WPD.MEDIA_USE_COUNT, ref val.Value);
                this.device.deviceProperties.SetValues(this.Id, portableDeviceValues, out result);
                ComTrace.WriteObject(result);
            }
        ...
        internal void SetAlbum(string value)
        {
            IPortableDeviceValues portableDeviceValues = new PortableDeviceValues() as IPortableDeviceValues;
            IPortableDeviceValues result;

            using (PropVariantFacade val = PropVariantFacade.StringToPropVariant(value))
            {
                portableDeviceValues.SetValue(ref WPD.MUSIC_ALBUM, ref val.Value);
                this.device.deviceProperties.SetValues(this.Id, portableDeviceValues, out result);
                ComTrace.WriteObject(result);
            }
        ...
        internal void SetArtist(string value)
        {
            IPortableDeviceValues portableDeviceValues = new PortableDeviceValues() as IPortableDeviceValues;
            IPortableDeviceValues result;
            ...
            using (PropVariantFacade val = PropVariantFacade.StringToPropVariant(value))
            {
                portableDeviceValues.SetValue(ref WPD.MEDIA_ARTIST, ref val.Value);
                this.device.deviceProperties.SetValues(this.Id, portableDeviceValues, out result);
                ComTrace.WriteObject(result);
            }
        ...
        internal void SetTrack(string value)
        {
            IPortableDeviceValues portableDeviceValues = new PortableDeviceValues() as IPortableDeviceValues;
            IPortableDeviceValues result;
            ...
            using (PropVariantFacade val = PropVariantFacade.StringToPropVariant(value))
            {
                portableDeviceValues.SetValue(ref WPD.MUSIC_TRACK, ref val.Value);
                this.device.deviceProperties.SetValues(this.Id, portableDeviceValues, out result);
                ComTrace.WriteObject(result);
            }
        ...
        internal void SetDuration(string value)
        {
            IPortableDeviceValues portableDeviceValues = new PortableDeviceValues() as IPortableDeviceValues;
            IPortableDeviceValues result;
            ...
            using (PropVariantFacade val = PropVariantFacade.StringToPropVariant(value))
            {
                portableDeviceValues.SetValue(ref WPD.MEDIA_DURATION, ref val.Value);
                this.device.deviceProperties.SetValues(this.Id, portableDeviceValues, out result);
                ComTrace.WriteObject(result);
            }
        ...
        internal void SetSubtitle(string value)
        {
            ...
            using (PropVariantFacade val = PropVariantFacade.StringToPropVariant(value))
            {
                portableDeviceValues.SetValue(ref WPD.MEDIA_SUB_TITLE, ref val.Value);
                this.device.deviceProperties.SetValues(this.Id, portableDeviceValues, out result);
                ComTrace.WriteObject(result);
            }
