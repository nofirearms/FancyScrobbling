...
namespace MediaDevices
{
    ...
    public abstract class MediaFileSystemInfo
    {
        ...
        /// <summary>
        /// Gets the amount of count use.
        /// </summary>
        public int? UseCount
        {
            get
            {
                return this.item.UseCount;
            }
            set
            {
                this.item.SetUseCount(value.GetValueOrDefault());
            }
        }

        public string? Album => this.item.Album;

        public string? Artist => this.item.Artist;

        public string? Track => this.item.Track;

        public string? Duration => this.item.Duration;

        public string? Subtitle => this.item.Subtitle;

        public string? Title => this.item.name;
